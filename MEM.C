...
void FailAssert(char *sz)
{
 ...
 // WinMessageBox(GetDesktopWindow(),sz,
 //	"Assertion Failure", MB_OK | MB_ICONEXCLAMATION | MB_APPLMODAL);
    // BUGBUG 29-Oct-1991 bens Need to exit app cleanly here
    // Exit application
}
...
char *MyStrDup(char *pch,char *pszFile,UINT line)
{
    UINT  cb;
    char *  pchDst;
